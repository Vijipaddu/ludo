...
app.get('/data', (req, res) => {
  const coins = db.query(`SELECT coins FROM accounts WHERE username='${getCookie("username")}';`);
  const wins = db.query(`SELECT wins FROM accounts WHERE username='${getCookie("username")}';`);
  console.log(`coins-${coins} wins-${wins}`)
